...
/**
 * Affiche les actions suceptibles d'etre effectuer sur un produit
 * 
 * @author MoOky
 */
public class ActionsPanel extends JPanel
{
    ...
    public void setProduct(Product productInProgress)
    {
        ...
        this.treeGuidances = new JTree(new GuidancesTreeModel(
                                                      ...
                                                      boolean focus)
        {
            ...
            Component c = null;
                ...
                if (value instanceof DefaultMutableTreeNode)
                {
                    ...
                    /*
                     * Color fc =
                     * GraphConstants.getForeground(node.getAttributes()); Color
                     * bc = GraphConstants.getBackground(node.getAttributes());
