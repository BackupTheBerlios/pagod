 ...
 * (effectué et à faire) pour une activité
 * Chargée lors du lancement d'une activité
 * ou de la terminaison d'une activité
 * 
...
public class TimeEditDialog extends JDialog implements ActionListener
{
	...
	/**
	 * constructeur prenant en paramètre le temps effectué
	 * et le temps estimé... 
	 * @param dParent 
	 * @param activity 
	 */
