/*
 * $Id: ProcessPanel.java,v 1.1 2005/10/30 10:44:59 yak Exp $
 *
 ...
 * @author MoOky
 */
public class ProcessPanel extends CommonProcessPanel
{
    /**
     ...
     */
    public ProcessPanel(ProcessTreeModel processTreeModel)
    {
        super(processTreeModel);
    }

    protected void onActivitySelection()
    {
        ActionManager.getInstance().getAction(Constants.ACTION_RUN_ACTIVITY)
                .setEnabled(true);
    }
