/*
 * $Id: GuidancesTreeModel.java,v 1.1 2005/10/30 10:44:59 yak Exp $
 *
...
/**
 * Classe permettant d'adapter les guides d'un produit donné pour en faire le
 * modele d'un JTree
 * 
...
public class GuidancesTreeModel extends DefaultTreeModel
{
     ...
     *            produit dont on veux adapter les guides pour en faire un JTree
     */
    public GuidancesTreeModel(Product product)
    {
        super(null);
    ...
    private void initGuidancesTreeModel()
    {
        ...
        if (this.root.getChildCount() == 0)
        {
                ...
                ((DefaultMutableTreeNode) this.root)
                        .add(new DefaultMutableTreeNode(new JLabel(
