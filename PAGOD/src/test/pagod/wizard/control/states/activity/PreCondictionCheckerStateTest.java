...
public class PreCondictionCheckerStateTest extends TestCase
{
	...
	public void testManageRequest ()
	{
		...
		assertFalse("Requete PREVIOUS envoyée a l'etat. Aucun changement ", 
		...
		assertTrue ("Requete NEXT envoyée a l'etat : changement vers l'etat. ActivityPresentationState",
