/*
 * $Id: PreferencesManagerTest.java,v 1.1 2005/10/30 10:45:00 yak Exp $
 *
 * SPWIZ - Spem Wizard
...
package test.pagod.configurator.control;
...
public class PreferencesManagerTest extends TestCase
{
    ...
    public void setUp()
    {
        ...
        for (String sExtension : PreferencesManager.getInstance()
                .preferences())
    ...
    /**
     * Test de getOutputDirectory()
     * 
     */
    public void testGetOutputDirectory()
    {
        // on defini le chemin de sortie comme etant le r?pertoire racine de
        // l'utilisateur courant
        PreferencesManager.getInstance().setOutputDirectory(
                System.getProperty("user.home"));

        // on test la methode getOutputDirectory
        assertTrue(PreferencesManager.getInstance().getOutputDirectory()
                .equals(System.getProperty("user.home")));

    }

    /**
     * Test de setOutputDirectory()
     * 
     */
    public void testSetOutputDirectory()
    {
        ...
        // on defini un autre repertoire comme etant celui de sorti du
        // configurateur
        PreferencesManager.getInstance().setOutputDirectory(
                System.getProperty("java.home"));

        assertTrue(PreferencesManager.getInstance().getOutputDirectory()
                .equals(System.getProperty("java.home")));
